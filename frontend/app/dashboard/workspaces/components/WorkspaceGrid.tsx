  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
      {workspaces.map((w) => (
        <div
          key={w.id}
          className="rounded-[20px] border border-black/5 dark:border-white/10 bg-card/40 p-5 backdrop-blur-xl transition-colors hover:bg-card/60 hover:border-black/10 dark:hover:border-white/20"
        >
